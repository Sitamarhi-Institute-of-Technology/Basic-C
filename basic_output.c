...
int main()
{
    ...
    */
    ...
    //# HOW TO PRINT NUMBERS AND DIGITS (NOT AS A STRING BUT AS A NUMBER)
        ...
        //   TO CHABGE IT YOU NEED TO DEFINE SIGNIFICANT FIGUERS IN FORMAT SPECIFIER LIKE %4.3F HERE 4 MEANS SIGNIFICANT FIGUERE BEFORE DECIMAL AND 3 REPRESENT SIGNIFICANT FIGURES AFTER DECIMAL
        printf("For example %4.3f , %6.2f, %1.2f ,%0.4f",11111.11111,11111.11111,11111.11111,11111.11111);
